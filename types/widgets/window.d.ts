...
declare const AgsWindow_base: {
    new (...args: any[]): {
        ...
        connections: ([GObject.Object, (self: any, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: any, ...args: unknown[]) => unknown] | [number, (self: any, ...args: unknown[]) => unknown])[];
        binds: [prop: string, obj: GObject.Object, objProp?: string | undefined, transform?: ((value: unknown) => unknown) | undefined][];
...
export default class AgsWindow extends AgsWindow_base {
    constructor({ anchor, exclusive, focusable, layer, margins, monitor, popup, visible, ...params }?: WindowProps);
